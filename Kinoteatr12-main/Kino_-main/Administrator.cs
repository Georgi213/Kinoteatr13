...
namespace Kinoteatr_bilet
{
    public partial class Administrator : Form
    {
        ...
        private void Add_Click(object sender, EventArgs e)
        {
            ...
            command.Parameters.AddWithValue("@Aasta", text2.Text);
            command.Parameters.AddWithValue("@Pilt", text3.Text);
        ...
        private void Update_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter adapter = new SqlDataAdapter("select  Nimi, Aasta,Pilt from [dbo].[Film]", connect_to_DB);
            adapter.Fill(tabel);
        ...
        private void Add_DL_Click(object sender, EventArgs e)
        {
            ...
            command = new SqlCommand("delete from Film where id = @id", connect_to_DB);
        ...
        private void Add_UP_Click(object sender, EventArgs e)
        {
            ...
            command = new SqlCommand("update Film set Nimi = @Nimi, Aasta = @Aasta, Pilt = @Pilt where id = @id", connect_to_DB);
            command.Parameters.AddWithValue("@id", Id);
            command.Parameters.AddWithValue("@Nimi", text1.Text);
            command.Parameters.AddWithValue("@Aasta", text2.Text);
            command.Parameters.AddWithValue("@Pilt", text3.Text);
